...
Do not commit the MSI or portable ZIP. GitHub blocks normal Git uploads larger than 100 MB. Upload these files from the local `release` directory as GitHub Release assets instead:
...
```powershell
cd windows
.\packaging\New-UpdateManifest.ps1 -Version 1.0.2 -Repository YOUR_ACCOUNT/YOUR_REPOSITORY
```
